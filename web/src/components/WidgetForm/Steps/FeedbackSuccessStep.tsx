    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className="px-6 py-2 mt-6 text-sm leading-6 transition-colors border-transparent rounded-md bg-zinc-800 hover:bg-zinc-600 focus:outline-none focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 focus:ring-2"
        >
          Quero enviar outro
        </button>
      </div>
